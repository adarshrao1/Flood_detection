...
function device_check() {
    ...
    if (check){
        ...
        map_check(iframe2.src,(screen.width / 2.045),1.5,screen.width,0.7,true);
        ...
        map_check(iframe2.src,(screen.width / 4),1,screen.width,0.3,false);
    }
}
function map_check(url,height,space,width,op,flag) {
    $.ajax({
        url: url,
        dataType: "jsonp",
        timeout: 5000,
